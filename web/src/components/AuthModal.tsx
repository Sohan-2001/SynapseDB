          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                SynapseDB Interactive Cloud Studio
              </p>
            </div>
          </div>
        ...
        <div className="p-5 sm:p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full min-h-[46px] rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm shadow-md shadow-blue-500/20 transition flex items-center justify-center gap-2 mt-2"
            >
              <span>{tab === "signup" ? "Create Account & Access Studio" : "Sign In & Access Studio"}</span>
          ...
          <div className="mt-5 pt-4 border-t border-slate-200/80 text-center">
            <p className="text-xs text-slate-500 mb-2.5">
              Just exploring? Skip the form and test instantly:
            </p>
            <button
              type="button"
              onClick={handleDemoAccess}
              className="w-full min-h-[42px] px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 font-semibold text-xs border border-slate-200 transition flex items-center justify-center gap-1.5"
            >
              <Zap className="w-3.5 h-3.5 text-amber-500 fill-current" />
              <span>1-Click Instant Demo Login (Guest Mode)</span>
            </button>
          </div>
