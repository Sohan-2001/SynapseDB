    ...
    return (
      <div className="min-h-screen bg-white text-slate-900 flex flex-col font-sans">
        ...
        <header className="fixed top-0 inset-x-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur-xl px-3 sm:px-6 safe-px py-3 shadow-2xs">
          ...
          {/* Mobile Menu Drawer */}
          {mobileMenuOpen && (
            <div className="md:hidden mt-3 pt-3 border-t border-slate-200/80 flex flex-col gap-2 animate-in slide-in-from-top-2 duration-150">
              {currentUser && (
                <div className="px-3 py-2 bg-emerald-50 rounded-xl border border-emerald-200 flex items-center justify-between text-xs">
                  <span className="font-semibold text-emerald-950">Signed in as {currentUser.name}</span>
                  <button
                    onClick={handleSignOut}
